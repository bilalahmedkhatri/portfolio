...
class TestimonialModel(models.Model):
    ...
    recommendation = models.CharField(max_length=2, choices=RECOMMANDATION, default="RE")
    ...
    test_image_02 = models.ImageField(upload_to=file_upload_add, blank=True, null=True)
