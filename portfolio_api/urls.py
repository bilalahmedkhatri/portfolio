...
from portfolio_api.views.testimonialview import testimonial_view, testimonial_form_submittion
...
urlpatterns = [
    ...
    path("testimonial-form-submittion", testimonial_form_submittion, name="testimonial-form"),
